...
<configuration>
  ...
  <typeAliases>
  	<!--typeAlias：设置某个具体的类型的别名,在整个MyBatis范围都有效，包括Mapper文件
    属性：
    type：需要设置别名的类型的全类名
  ...
  <mappers>
    ...
    注意：此方式必须保证mapper接口和mapper映射文件必须在相同的包路径下同名
    例如java/com/hqw/mybatis/mapper/ParameterMapper.java
    resources/com/hqw/mybatis/mapper/ParameterMapper.xml
    -->
