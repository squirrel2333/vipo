...
其他解决方案：全局设置前缀 ([https://www.baomidou.com/pages/56bac0/#基本配置](https://www.baomidou.com/pages/56bac0/#%E5%9F%BA%E6%9C%AC%E9%85%8D%E7%BD%AE))
...
mybatis-plus:
  ...
  global-config:
    db-config:
      ...
      id-type: auto
```
`log-impl: org.apache.ibatis.logging.stdout.StdOutImpl`可以在日志中打印出sql语句
