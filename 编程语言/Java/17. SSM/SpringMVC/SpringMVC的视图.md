...
4. 配置springMVC
1. 组件扫描
2. 使用`InternalResourceViewController`代替Thymeleaf视图解析器
...
```
7. WEB-INF/templates下创建success.jsp
...
```
如果return的view没有任何前缀或者以forward为前缀的时候，将会被InternalResourceView解析

如果以redirect为前缀，创建RedirectView视图
