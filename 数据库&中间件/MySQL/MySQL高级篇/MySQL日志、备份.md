...
修改 `my.cnf` 或者 `my.ini` 文件，把[mysqld]组下的 `general\_log` 值设置为 `OFF` 或者把general\_log一项 注释掉。修改保存后，再`重启MySQL服务` ，即可生效。
...
```
官网提示：
![](MySQL%E6%97%A5%E5%BF%97%E4%B8%8E%E5%A4%87%E4%BB%BD%E7%AF%87.assets/image-20220715161132368.png) ![](MySQL日志、备份_006.png)
...
![](MySQL日志与备份篇.assets/image-20220715161800635.png)![](MySQL日志、备份_009.png)
...
![](MySQL日志与备份篇.assets/image-20220715164107352.png)**方式2：临时性方式**
...
MySQL服务 `重新启动一次` ，以“.000001”为后缀的文件就会增加一个，并且后缀名按1递增。即日志文件的 个数与MySQL服务启动的次数相同；如果日志长度超过了 `max\_binlog\_size` 的上限（默认是1GB），就会创建一个新的日志文件。
...
![](MySQL日志与备份篇.assets/image-20220715164718970.png)![](MySQL日志、备份_015.png)
...
![](MySQL日志与备份篇.assets/image-20220715165603879.png)上面我们讲了这么多都是基于binlog的默认格式，binlog格式查看
...
![](MySQL日志与备份篇.assets/image-20220715171712026.png)![](MySQL日志、备份_019.png)
...
我们可以通过`binlog\_cache\_size`参数控制单个线程 binlog cache 大小，如果存储内容超过了这个参数，就要暂存到磁盘（Swap）。binlog日志刷盘流程如下：

![](MySQL日志、备份_021.png)

* 上图的write，是指把日志写入到文件系统的page cache，并没有把数据持久化到磁盘，所以速度比较快
* 上图的fsync，才是将数据持久化到磁盘的操作
write和fsync的时机，可以由参数 `sync\_binlog` 控制，默认是 `0` 。为0的时候，表示每次提交事务都只 write，由系统自行判断什么时候执行fsync。虽然性能得到提升，但是机器宕机，page cache里面的 binglog 会丢失。如下图：

![](MySQL%E6%97%A5%E5%BF%97%E4%B8%8E%E5%A4%87%E4%BB%BD%E7%AF%87.assets/image-20220715193749462.png)

为了安全起见，可以设置为 `1` ，表示每次提交事务都会执行fsync，就如同**redo log 刷盘流程**一样。 最后还有一种折中方式，可以设置为N(N>1)，表示每次提交事务都write，但累积N个事务后才fsync。

![](MySQL%E6%97%A5%E5%BF%97%E4%B8%8E%E5%A4%87%E4%BB%BD%E7%AF%87.assets/image-20220715194624080.png)
...
![](MySQL%E6%97%A5%E5%BF%97%E4%B8%8E%E5%A4%87%E4%BB%BD%E7%AF%87.assets/image-20220715194959405.png)
...
![](MySQL%E6%97%A5%E5%BF%97%E4%B8%8E%E5%A4%87%E4%BB%BD%E7%AF%87.assets/image-20220715195016492.png)

由于binlog没写完就异常，这时候binlog里面没有对应的修改记录。因此，之后用binlog日志恢复数据时，就会少这一次更新，恢复出来的这一行c值为0，而原库因为redo log日志恢复，这一行c的值是1，最终数据不一致。

![](MySQL%E6%97%A5%E5%BF%97%E4%B8%8E%E5%A4%87%E4%BB%BD%E7%AF%87.assets/image-20220715195521986.png)

为了解决两份日志之间的逻辑一致问题，InnoDB存储引擎使用**两阶段提交**方案。原理很简单，将redo log的写入拆成了两个步骤prepare和commit，这就是**两阶段提交**。

![](MySQL%E6%97%A5%E5%BF%97%E4%B8%8E%E5%A4%87%E4%BB%BD%E7%AF%87.assets/image-20220715195635196.png)

使用两阶段提交后，写入binlog时发生异常也不会有影响，因为MySQL根据redo log日志恢复数据时，发现redo log还处于prepare阶段，并且没有对应binlog日志，就会回滚该事务。

![](MySQL%E6%97%A5%E5%BF%97%E4%B8%8E%E5%A4%87%E4%BB%BD%E7%AF%87.assets/image-20220715200248193.png)

另一个场景，redo log设置commit阶段发生异常，那会不会回滚事务呢？

![](MySQL%E6%97%A5%E5%BF%97%E4%B8%8E%E5%A4%87%E4%BB%BD%E7%AF%87.assets/image-20220715200321717.png)
...
![](MySQL%E6%97%A5%E5%BF%97%E4%B8%8E%E5%A4%87%E4%BB%BD%E7%AF%87.assets/image-20220715202237535.png)
...
![](MySQL%E6%97%A5%E5%BF%97%E4%B8%8E%E5%A4%87%E4%BB%BD%E7%AF%87.assets/image-20220715212521601.png)
...
![](MySQL日志与备份篇.assets/image-20220715214055057.png)
...
![](MySQL%E6%97%A5%E5%BF%97%E4%B8%8E%E5%A4%87%E4%BB%BD%E7%AF%87.assets/image-20220715215944767.png)
...
![](MySQL%E6%97%A5%E5%BF%97%E4%B8%8E%E5%A4%87%E4%BB%BD%E7%AF%87.assets/image-20220715220037213.png)
...
![](MySQL%E6%97%A5%E5%BF%97%E4%B8%8E%E5%A4%87%E4%BB%BD%E7%AF%87.assets/image-20220715220852836.png)
...
+ 复制以下几种语句时的行锁更少：INSERT ... SELECT、包含 AUTO\_INCREMENT 字段的 INSERT、 没有附带条件或者并没有修改很多记录的 UPDATE 或 DELETE 语句
...
Last\_IO\_Error: error connecting to master 'slave1@192.168.1.150:3306' - retry-time: 60 retries: 1 message:

Authentication plugin 'caching\_sha2\_password' reported error: Authentication requires secure connection.
...
![](MySQL%E6%97%A5%E5%BF%97%E4%B8%8E%E5%A4%87%E4%BB%BD%E7%AF%87.assets/image-20220718140722740.png)
...
![](MySQL%E6%97%A5%E5%BF%97%E4%B8%8E%E5%A4%87%E4%BB%BD%E7%AF%87.assets/image-20220718140946747.png)
...
![](MySQL%E6%97%A5%E5%BF%97%E4%B8%8E%E5%A4%87%E4%BB%BD%E7%AF%87.assets/image-20220718141825228.png)

如果报错：

![](MySQL%E6%97%A5%E5%BF%97%E4%B8%8E%E5%A4%87%E4%BB%BD%E7%AF%87.assets/image-20220718141841862.png)
...
![](MySQL%E6%97%A5%E5%BF%97%E4%B8%8E%E5%A4%87%E4%BB%BD%E7%AF%87.assets/image-20220718141951374.png)
...
![](MySQL日志与备份篇.assets/image-20220718142045114.png)
...
![](MySQL%E6%97%A5%E5%BF%97%E4%B8%8E%E5%A4%87%E4%BB%BD%E7%AF%87.assets/image-20220718142549168.png)
...
![](MySQL%E6%97%A5%E5%BF%97%E4%B8%8E%E5%A4%87%E4%BB%BD%E7%AF%87.assets/image-20220718143705843.png)

![](MySQL%E6%97%A5%E5%BF%97%E4%B8%8E%E5%A4%87%E4%BB%BD%E7%AF%87.assets/image-20220718143716620.png)
...
![](MySQL日志与备份篇.assets/image-20220718144051094.png)
...
![](MySQL%E6%97%A5%E5%BF%97%E4%B8%8E%E5%A4%87%E4%BB%BD%E7%AF%87.assets/image-20220718144341584.png)
...
![](MySQL%E6%97%A5%E5%BF%97%E4%B8%8E%E5%A4%87%E4%BB%BD%E7%AF%87.assets/image-20220718144410731.png)

#### 方法 2：半同步复制

![](MySQL日志与备份篇.assets/image-20220718144926758.png)

![](MySQL%E6%97%A5%E5%BF%97%E4%B8%8E%E5%A4%87%E4%BB%BD%E7%AF%87.assets/image-20220718144958357.png)
...
![](MySQL%E6%97%A5%E5%BF%97%E4%B8%8E%E5%A4%87%E4%BB%BD%E7%AF%87.assets/image-20220718145235499.png)
...
![](MySQL%E6%97%A5%E5%BF%97%E4%B8%8E%E5%A4%87%E4%BB%BD%E7%AF%87.assets/image-20220718145428456.png)
...
![](MySQL%E6%97%A5%E5%BF%97%E4%B8%8E%E5%A4%87%E4%BB%BD%E7%AF%87.assets/image-20220718145523643.png)

![](MySQL%E6%97%A5%E5%BF%97%E4%B8%8E%E5%A4%87%E4%BB%BD%E7%AF%87.assets/image-20220718145534856.png)

主备切换：

![](MySQL%E6%97%A5%E5%BF%97%E4%B8%8E%E5%A4%87%E4%BB%BD%E7%AF%87.assets/image-20220718145548526.png)
...
![](MySQL日志与备份篇.assets/image-20220718145936444.png)
...
![](MySQL日志与备份篇.assets/image-20220718163627669.png)
...
![](MySQL%E6%97%A5%E5%BF%97%E4%B8%8E%E5%A4%87%E4%BB%BD%E7%AF%87.assets/image-20220718165515965.png)

## 8. 删库了不敢跑，能干点啥？

![](MySQL日志与备份篇.assets/image-20220718165738367.png)

### 8.1 delete：误删行

![](MySQL日志与备份篇.assets/image-20220718165909464.png)

### 8.2 truncate/drop ：误删库/表

![](MySQL日志与备份篇.assets/image-20220718170026929.png)

### 8.3 预防使用truncate/drop误删库/表

![](MySQL日志与备份篇.assets/image-20220718170132339.png)

![](MySQL日志与备份篇.assets/image-20220718170215247.png)
